...
(let ((class '((class color) (min-colors 89)))
      ...
      (code-block '(:foreground "#000088" :background "#FFFFF1"))
  ...
  (custom-theme-set-faces
   ...
   `(org-block-begin-line ((,class (:underline "#A7A6AA" :foreground "#555555" :background "#F2F1F5"))))
   `(org-block-end-line ((,class (:overline "#A7A6AA" :foreground "#555555" :background "#F2F1F5"))))
