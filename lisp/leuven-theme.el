...
(let ((class '((class color) (min-colors 89)))
      ...
      (directory '(:weight bold :foreground "blue"))
      ...
      (ol1 `(,@(leuven-scale-font leuven-scale-outline-headlines 1.3) :weight bold :underline "#A7A7A7" :foreground "#3C3C3C"))
      (ol2 '(:height 1.0 :weight bold :underline "#123555" :foreground "#123555"))
      (ol3 '(:height 1.0 :weight bold :foreground "#005522"))
  ...
  (custom-theme-set-faces
   ...
   `(org-block-background ((,class (:background "#FFFFF1")))) ;; :inherit fixed-pitch))))
   ...
   `(org-meta-line ((,class (:slant normal :foreground "#008ED1"))))
